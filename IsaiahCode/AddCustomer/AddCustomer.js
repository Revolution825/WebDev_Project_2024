...
//Date:25/02/2024
function confirmChoices() //Function that gives the user a confirmation box to decide if the customer details entered are correct before the form gets submitted
{
    var confirmation
...
function checkAge() //Function to check the age entered by the user and ensuring the age of the customer entered is greater than 18
{
